...
def leaf_node_group(mat, rgb):
    ...
    #node Group
    group = leaf.nodes.new("ShaderNodeGroup")
    group.node_tree = bpy.data.node_groups["leafnode"]
    #Input_1
    group.inputs[0].default_value = rgb
    #Input_13
    ...
    leaf.links.new(group.outputs[0], material_output.inputs[0])