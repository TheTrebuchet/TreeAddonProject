...
def barkgroup_node_group():
    ...
    rgb_curves_curve_3_point_1.location = (0.08181818574666977, 0.1499999761581421)
    rgb_curves_curve_3_point_1.handle_type = 'AUTO'
    rgb_curves_curve_3_point_2 = rgb_curves_curve_3.points.new(0.21363691985607147, 0.8312504291534424)
    ...
    colorramp_cre_0.color = (0.012983039021492004, 0.008568127639591694, 0.002124689519405365, 1.0)

    colorramp_cre_1 = colorramp.color_ramp.elements.new(0.054545484483242035)
    colorramp_cre_1.alpha = 1.0
    colorramp_cre_1.color = (0.21785758435726166, 0.18782173097133636, 0.1369573324918747, 1.0)

    colorramp_cre_2 = colorramp.color_ramp.elements.new(1.0)
    colorramp_cre_2.alpha = 1.0
    colorramp_cre_2.color = (0.6724432706832886, 0.5209956765174866, 0.29177066683769226, 1.0)
    ...
    #B_Color
    mix_002.inputs[7].default_value = (0.041687678545713425, 0.041687678545713425, 0.041687678545713425, 1.0)
    ...
    colorramp_001_cre_0.color = (0.16537627577781677, 0.12001702189445496, 0.05650651082396507, 1.0)

    colorramp_001_cre_1 = colorramp_001.color_ramp.elements.new(1.0)
    colorramp_001_cre_1.alpha = 1.0
    colorramp_001_cre_1.color = (0.41593509912490845, 0.3226011395454407, 0.15277840197086334, 1.0)
    ...
    barkgroup.links.new(vector_math_005.outputs[0], noise_texture_002.inputs[0])
    ...
    barkgroup.links.new(voronoi_texture_001.outputs[1], colorramp_001.inputs[0])
    ...
    barkgroup.links.new(vector_math_003.outputs[0], noise_texture_003.inputs[0])
    ...
    barkgroup.links.new(vector_math_003.outputs[0], noise_texture_004.inputs[0])
    ...
    barkgroup.links.new(hue_saturation_value.outputs[0], principled_bsdf_1.inputs[0])
    ...
    barkgroup.links.new(hue_saturation_value.outputs[0], group_output.inputs[0])
    ...
    barkgroup.links.new(vector_math_003.outputs[0], noise_texture_005.inputs[0])
...
def calmtree_bark_node_group(mat):
    ...
    #Subsurface Color
    principled_bsdf.inputs[3].default_value = (0.05012740194797516, 0.08010157942771912, 0.3986773192882538, 1.0)
    #Subsurface IOR
    ...
    calmtree_bark.links.new(principled_bsdf.outputs[0], material_output.inputs[0])
